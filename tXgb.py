...
def main():
    ...
    clf = GridSearchCV(XGBClassifier(reg_alpha=0,max_depth=6,learning_rate=0.5,min_child_weight=1,scale_pos_weight=1
    ,objective="multi:softmax",num_class=2),param,cv=5,scoring='recall')
